...
public class Paging_Design_Admin_Notice {
    public static String getPaging(String pageURL, int nowPage, int rowTotal, String search_param, int blockList, int blockPage) {
        ...
        // 맨 처음 페이지 버튼
        if (nowPage > 1) {
            sb.append("<li class='outer'><a href='" + pageURL + "?page=1&search_param=" + search_param + "'>◀◀</a></li>");
        } else {
        ...
        // 이전 페이지 버튼
        if (isPrevPage) {
            sb.append("<li class='inner'><a href='" + pageURL + "?page=" + (nowPage - 1) + "&search_param=" + search_param + "'>◀</a></li>");
        } else {
        ...
        for (int i = startPage; i <= endPage; i++) {
            ...
            if (i == nowPage) {
                ...
                sb.append("<li><a href='" + pageURL + "?page=" + i + "&search_param=" + search_param + "'>" + i + "</a></li>");
            }
        }
        ...
        // 맨 마지막 페이지 버튼
        if (nowPage < totalPage) {
            sb.append("<li class='outer'><a href='" + pageURL + "?page=" + totalPage + "&search_param=" + search_param + "'>▶▶</a></li>");
        } else {
            sb.append("<li class='outer disabled'><span>▶▶</span></li>");
        }
