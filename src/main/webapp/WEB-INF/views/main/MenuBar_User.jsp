...
<html>
	<head>
		...
		<script src="/hos/resources/js/menubar_user.js?v=1.0"></script>
			...
			<center>
				<div id="menubar_inner">
					...
					<a href="step1.do?pat_idx=${param.pat_idx}" id="reservation" 
						onmouseover="reservationContent()">진료예약/안내</a>
						
					<a href="info_notice_list.do" id="board" 
						onmouseover="boardContent()">병원게시판</a>
						
					<a href="way_info.do" id="introduce" 
						onmouseover="introduceContent()">병원안내</a>
						
					<a href="diagnosis_list.do" id="health" 
