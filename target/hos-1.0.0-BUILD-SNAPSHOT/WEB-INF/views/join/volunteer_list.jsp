	...
	<head>
		...
		<script>
			...
			function search(){
				...
				location.href="join_volunteer_list.do?pat_idx=${param.pat_idx}"+
						  "&search="+search+
				...
				<table>
					...
					<c:forEach var="vo" items="${list}" varStatus="count">
						<tr>
							...
							<td id="title_td">
								<a href="join_volunteer_view.do?pat_idx=${param.pat_idx}&vol_idx=${vo.vol_idx}&page=${param.page}">${vo.vol_title}</a>
							</td>
