	...
	<head>
		...
		<script>
			function insert(f){
			    ...
			    let board_email1 = f.board_email1.value;
			    let board_email2 = f.board_email2.value;
			  ...
			  //유효성체크
				...
				f.action = "join_board_insert.do?pat_idx=${param.pat_idx}";
				f.submit();
			}
			...
			<form method="post"
				...
				<table>
					...
					<tr class="last_tr">
						<th>첨부파일</th>
						<td>
							<input type="file" class="file_btn" name="photo"/>
							<p>(5MB 이하)파일이름은 영문으로 작성해 주시기 바랍니다.</p>
						</td>
					</tr>
				</table>
